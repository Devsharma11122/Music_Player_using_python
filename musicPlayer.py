...
class player(tk.Frame):
    ...
    def create_frames(self):
        ...
        self.controls.configure(width=410, height=100)
    ...
    def control_widgets(self):
        ...
        self.loadsongs['text']= 'Load'
        self.loadsongs['command']= self.retrieve_songs
        self.loadsongs.grid(row=0,column=0,padx=10)

        self.prev = tk.Button(self.controls, bg='blue', fg = 'white', font = 10)
        self.prev['text']= '<<'
        self.prev['command']= self.prev_song
        self.prev.grid(row=0,column=1,padx=10)

        self.pause = tk.Button(self.controls, bg='red', fg = 'white', font = 10)
        self.pause['text']= '||'
        self.pause['command']= self.pause_song
        self.pause.grid(row=0,column=2,padx=10)


        self.next = tk.Button(self.controls, bg='blue', fg = 'white', font = 10)
        self.next['text']= '>>'
        self.next['command']= self.next_song
        self.next.grid(row=0,column=3,padx=10)
...
img = PhotoImage(file='music1.png')
next = PhotoImage(file='next1.png')
prev = PhotoImage(file='music1.png')
pause = PhotoImage(file='music1.png')
